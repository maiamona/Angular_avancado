...
describe('Teste comportamental do Pipe', () =>{
  ...
  it('Deve converter byte para MB', () =>{
fixture.detectChanges();
expect(el.textContent).toBe(' Size: 117.74 MB ');
component.size = 1029281;
fixture.detectChanges();
expect(el.textContent).toBe(' Size: 0.98 MB ');
  });

  it('Deve converter byte para GB', () =>{
    component.size = 1342177280;
    fixture.detectChanges();
    expect(el.textContent).toBe(' Size: 1.25 GB ');
  });
});
});
